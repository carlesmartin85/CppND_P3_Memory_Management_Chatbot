...
private:
    ...
    std::unique_ptr<ChatLogic> _chatLogic; // cmartin: Define unique_ptr to handle _chatLogic
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); } // cmartin: Dereference unique_ptr
